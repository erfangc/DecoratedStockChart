        ...
        .directive("dscClickOutside", function () {
            return {
                ...
                link: function (scope, element) {
                    const documentClickListener = $(document).click(function () {
                        if (scope.openState)
                            scope.closeCallback();
                    });
                    const elementClickListener = element.click(function (e) {
                        e.stopPropagation();
                    });

                    // Unbind click listeners when element is removed
                    scope.$on('$destroy', function(){
                        documentClickListener.off();
                        elementClickListener.off();
                    });
                }
            }
        });
